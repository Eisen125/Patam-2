...
public class Zscore extends HybridAlgorithm implements TimeSeriesAnomalyDetector {
   // Point[] points;
    float threshold;
    ...
    public void learnNormal(TimeSeries ts) {
       ...
       /* notCorrelatedColThreshold= new HashMap<String, Float>();
        ...
        ts.values.forEach(fs->{float maxThreshold=findMaxThreshold(FloatTofloat(fs));
